import gameService from 'shared/services/game.js';
// const gameService = new GameService();
import path from 'path';
import fs from 'fs';
import { createRequire } from 'module';
import { fileURLToPath } from 'url';
import { Game } from 'shared/types/game.js';
...
async function getGameMeta(urlpath) {
    try {
        ...
        let result:Game = await gameService.findGame(game_slug, true);
        let game = result;
...
export { renderHTML, renderSITEMAP, renderRobotsTxt  };
