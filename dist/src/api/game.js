...
export default class GameAPI {
    ...
    actionRoutes(middleware) {
        ...
        this.actionRouter.post(`/api/v1/game/achievement/claim`, middleware, this.apiClaimAchievement.bind(this));
    ...
    async apiClaimAchievement(req, res, next) {
        try {
            ...
            let results = await achievements.claimAchievement(game_slug, shortid, achievement_slug);
            res.json(results);
        }
        catch (e) {
            next(e);
