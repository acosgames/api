...
export default class SocialAuth {
    ...
    routes() {
        ...
        this.router.get("/oauth/microsoft", passport.authenticate("microsoft", {
            failureRedirect: "/",
            session: false,
        }), this.redirectSocial);
        this.router.get("/login/facebook", passport.authenticate("facebook", { session: false }));
        this.router.get("/oauth/facebook", passport.authenticate("facebook", {
            failureRedirect: "/",
            session: false,
        }), this.redirectSocial);
        this.router.get("/login/github", passport.authenticate("github", { session: false }));
        this.router.get("/oauth/github", passport.authenticate("github", {
            failureRedirect: "/",
            session: false,
        }), this.redirectSocial);
        return this.router;
    ...
    async apiCreateTempUser(req, res, next) {
        try {
            ...
            let portraitid = req.body?.portraitid ||
